...
app.post("/generar-pdf", async (req, res) => {
    ...
    const browser = await puppeteer.launch({
        executablePath: process.env.PUPPETEER_EXECUTABLE_PATH || "/vercel/.cache/puppeteer/chrome/linux-134.0.6998.35/chrome-linux64/chrome",
        headless: "new",
    ...
    productos.forEach((producto, index) => {
        ...
        // Posiciones base
        const xSimbolo = xPos + 70; // Posición del "S/"
